...
int main(){
    ...
    switch (tipo_arvore) {
        case 1:
            ...
            cout << "  \'-> Criação de Arvore Binaria Simples Concluida!" << endl;
            break;
        case 2:
            arvore = make_shared<AVL_tree>(chave_no, conteudo_no);
            cout << "  \'-> Criação de Arvore AVL!" << endl;
            break;
        case 3:
            arvore = make_shared<red_black_tree>(chave_no, conteudo_no);
            cout << "  \'-> Criação de Arvore Rubro-Negra!" << endl;
            break;
    }
    ...
    while (operacao != 5) {
        ...
        switch (operacao) {
            ...
            case 3: {
                ...
                else {cout << "  |-> Conteudo do elemento: " << arvore->search(chave_no) << endl;}
